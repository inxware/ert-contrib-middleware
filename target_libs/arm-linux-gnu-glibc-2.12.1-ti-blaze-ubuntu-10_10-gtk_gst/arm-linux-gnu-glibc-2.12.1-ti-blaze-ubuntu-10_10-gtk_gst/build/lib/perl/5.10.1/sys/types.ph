...
unless(defined(&_SYS_TYPES_H)) {
    ...
    if((defined (defined(&__USE_SVID) ? &__USE_SVID : undef) || defined (defined(&__USE_XOPEN) ? &__USE_XOPEN : undef) || defined (defined(&__USE_XOPEN2K8) ? &__USE_XOPEN2K8 : undef))  && !defined (defined(&__id_t_defined) ? &__id_t_defined : undef)) {
    ...
    if(defined (defined(&__USE_XOPEN) ? &__USE_XOPEN : undef) || defined (defined(&__USE_XOPEN2K8) ? &__USE_XOPEN2K8 : undef)) {
    ...
    if((defined (defined(&__USE_UNIX98) ? &__USE_UNIX98 : undef) || defined (defined(&__USE_XOPEN2K8) ? &__USE_XOPEN2K8 : undef))  && !defined (defined(&__blksize_t_defined) ? &__blksize_t_defined : undef)) {
