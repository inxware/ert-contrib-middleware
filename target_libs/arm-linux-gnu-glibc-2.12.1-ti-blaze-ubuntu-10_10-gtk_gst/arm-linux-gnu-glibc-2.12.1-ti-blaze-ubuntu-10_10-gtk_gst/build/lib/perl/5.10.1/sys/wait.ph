...
unless(defined(&_SYS_WAIT_H)) {
    ...
    if(!defined (defined(&_STDLIB_H) ? &_STDLIB_H : undef) || (!defined (defined(&__USE_XOPEN) ? &__USE_XOPEN : undef)  && !defined (defined(&__USE_XOPEN2K8) ? &__USE_XOPEN2K8 : undef))) {
    ...
    if(defined (defined(&__USE_SVID) ? &__USE_SVID : undef) || defined (defined(&__USE_XOPEN) ? &__USE_XOPEN : undef) || defined (defined(&__USE_XOPEN2K8) ? &__USE_XOPEN2K8 : undef)) {
