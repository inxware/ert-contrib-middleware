...
unless(defined(&_SIGNAL_H)) {
	...
	if(defined (defined(&__USE_BSD) ? &__USE_BSD : undef) || defined (defined(&__USE_XOPEN_EXTENDED) ? &__USE_XOPEN_EXTENDED : undef) || defined (defined(&__USE_XOPEN2K8) ? &__USE_XOPEN2K8 : undef)) {
