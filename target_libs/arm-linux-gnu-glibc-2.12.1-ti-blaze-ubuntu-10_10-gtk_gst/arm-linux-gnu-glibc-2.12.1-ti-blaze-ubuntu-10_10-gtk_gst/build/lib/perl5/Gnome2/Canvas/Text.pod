...
=item 'attributes' (Pango::AttrList : readable / writable)
...
=item 'font-desc' (Pango::FontDescription : readable / writable)
...
=item 'stretch' (Pango::Stretch : readable / writable)
...
=item 'style' (Pango::Style : readable / writable)
...
=item 'underline' (Pango::Underline : readable / writable)
...
=item 'variant' (Pango::Variant : readable / writable)
