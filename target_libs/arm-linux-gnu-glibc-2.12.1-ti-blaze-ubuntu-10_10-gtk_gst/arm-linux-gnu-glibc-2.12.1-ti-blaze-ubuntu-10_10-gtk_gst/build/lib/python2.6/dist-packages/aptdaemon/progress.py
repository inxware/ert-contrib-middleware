...
class DaemonInstallProgress(object):
    ...
    def start_update(self):
        ...
        # we re-acquire the archive lock here, python-apt will have released
        # it in apt.Cache._fetch_archives() (see #597017)
        lock.archive_lock.acquire()
        # and release the dpkg lock so that dpkg can actually do its work
