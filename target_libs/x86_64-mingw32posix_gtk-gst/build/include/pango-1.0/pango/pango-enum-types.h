...
PANGO_AVAILABLE_IN_ALL
GType pango_width_get_type (void) G_GNUC_CONST;
#define PANGO_TYPE_WIDTH (pango_width_get_type ())
PANGO_AVAILABLE_IN_ALL
...
PANGO_AVAILABLE_IN_ALL
GType pango_render_component_get_type (void) G_GNUC_CONST;
#define PANGO_TYPE_RENDER_COMPONENT (pango_render_component_get_type ())
