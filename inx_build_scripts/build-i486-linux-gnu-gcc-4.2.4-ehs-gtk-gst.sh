...
TOOLCHAIN_VERSION="i686-pc-linux-gnu-4.2.4"
#TOOLCHAIN_VERSION=""
...
#	--disable-telx --disable-zvbi \
#	--disable-speex --disable-shout --disable-dvbpsi \
 #       --disable-qt4  --disable-skins2 --disable-bonjour --disable-udev --disable-mtp  \
