/*
 * $Id: Xrenderint.h,v 1.14 2004/04/11 06:58:13 keithp Exp $
 *
...
#include "config.h"
/*
 * Solaris seems to want string.h included.  Seems harmless enough
 * so we'll just include it whenever it exists
 */
#if HAVE_STRING_H
#include <string.h>
#endif
