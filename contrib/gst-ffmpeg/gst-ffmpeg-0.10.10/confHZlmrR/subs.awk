...
S["Q"]="$(V:1=)"
S["V"]="@"
S["OBJC"]="/bin/sh /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common/shave objc "
S["F77"]="/bin/sh /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common/shave f77 "
S["FC"]="/bin/sh /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common/shave fc "
S["CXX"]="/bin/sh /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common/shave cxx i686-pc-linux-gnu-g++"
S["AM_MAKEFLAGS"]="`test -z $V && echo -s`"
S["MAKEFLAGS"]="-s"
S["shavedir"]="/home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common"
S["HAVE_FFMPEG_UNINSTALLED_FALSE"]="#"
S["HAVE_FFMPEG_UNINSTALLED_TRUE"]=""
S["WIN32_LIBS"]=""
S["FFMPEG_SUBDIRS"]="gst-libs"
S["FFMPEG_EXTERNALS_REVISION"]="30520"
S["FFMPEG_REVISION"]="21874"
S["FFMPEG_SVN"]="svn://svn.ffmpeg.org/ffmpeg/trunk"
...
S["GST_OPTION_CFLAGS"]="$(ERROR_CFLAGS) $(DEBUG_CFLAGS) $(PROFILE_CFLAGS) $(GCOV_CFLAGS) $(OPT_CFLAGS) $(DEPRECATED_CFLAGS)"
S["DEPRECATED_CFLAGS"]=""
S["PROFILE_CFLAGS"]=""
S["GST_LEVEL_DEFAULT"]="GST_LEVEL_NONE"
S["ERROR_CFLAGS"]="-Wall -Wdeclaration-after-statement -Wvla -Wpointer-arith"
...
S["LIBOIL_LIBS"]="-L/home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/inx_build_scripts/../target_libs/i686-linux-gnu-i686-pc-linux-gnu-4.4.6-gtk_gst/bu"\
"ild/lib -loil-0.3 -lm -lrt  "
S["LIBOIL_CFLAGS"]="-I/home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/inx_build_scripts/../target_libs/i686-linux-gnu-i686-pc-linux-gnu-4.4.6-gtk_gst/bu"\
"ild/include/liboil-0.3  "
...
"lease/INX/comp-lib-support/inx_build_scripts/../target_libs/i686-linux-gnu-i686-pc-linux-gnu-4.4.6-gtk_gst/build/lib/glib-2.0/include   $(GST_OPTION"\
"_CFLAGS)"
S["LIBM"]="-lm"
...
S["CC"]="/bin/sh /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common/shave cc i686-pc-linux-gnu-gcc"
S["LIBTOOL"]="/bin/sh /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/common/shave-libtool '$(SHELL) $(top_b"\
"uilddir)/libtool'"
S["OBJDUMP"]="objdump"
S["DLLTOOL"]="dlltool"
...
S["PACKAGE_VERSION_MICRO"]="10"
S["PACKAGE_VERSION_MINOR"]="10"
S["PACKAGE_VERSION_MAJOR"]="0"
S["am__untar"]="${AMTAR} xf -"
S["am__tar"]="${AMTAR} chof - \"$$tardir\""
S["AMTAR"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/missing --run tar"
S["am__leading_dot"]="."
S["SET_MAKE"]=""
S["AWK"]="gawk"
...
S["STRIP"]="strip"
S["install_sh"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/install-sh"
S["MAKEINFO"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/missing --run makeinfo"
S["AUTOHEADER"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/missing --run autoheader"
S["AUTOMAKE"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/missing --run automake-1.11"
S["AUTOCONF"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/missing --run autoconf"
S["ACLOCAL"]="${SHELL} /home/pdrezet/workspace/inxware2.0-Release/INX/comp-lib-support/contrib/gst-ffmpeg/gst-ffmpeg-0.10.10/missing --run aclocal-1.11"
S["VERSION"]="0.10.10"
...
S["PACKAGE_STRING"]="GStreamer FFMpeg 0.10.10"
S["PACKAGE_VERSION"]="0.10.10"
