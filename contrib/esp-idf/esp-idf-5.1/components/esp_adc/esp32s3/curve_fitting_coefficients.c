 ...
 */
const static DRAM_ATTR uint64_t adc1_error_coef_atten[COEFF_GROUP_NUM][TERM_MAX][2] = {
 ...
 * Term sign
 */
const static DRAM_ATTR int32_t adc1_error_sign[COEFF_GROUP_NUM][TERM_MAX] = {
