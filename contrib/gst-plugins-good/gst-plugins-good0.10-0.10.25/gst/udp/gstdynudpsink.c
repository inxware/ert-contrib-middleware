...
{
  guint bc_val;
  printf("GST-GOOD-gst_dynudpsink_init_send\n");
  if (sink->sockfd == -1) {
    /* create sender socket if none available */
	  printf("GST-GOOD-Creating a new Socket - Don't know hwere to...\n");
    ...
    sink->externalfd = TRUE;
	  ...
	  printf("GST-GOOD-Doing something weird with Socket - Don't know why...\n");
